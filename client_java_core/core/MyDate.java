...
/**
 * Description:
 * Preleva la data e ora corrente secondo il formato "dd/MM/yyyy  HH:mm:ss:SSS"
 * 	LEGENDA
 * 	dd: giorno
 * 	MM: mese
 * 	yyyy: anno
...
public class MyDate {
	Date date = null;
	SimpleDateFormat dateFormat = null; //per vedere il nome del mese sostituire MM con MMMM
	String dataOra = null;
	 ...
	 */
	public MyDate(){
		dateFormat = new SimpleDateFormat("dd/MM/yyyy  HH:mm:ss:SSS"); //per vedere il nome del mese sostituire MM con MMMM
	}
